...
const CHAPTER4 = [
  ...
  {
    file: 'chapter4/06-c4-esquinas-afiladas.json',
    id: 'c4-esquinas-afiladas', name: 'Esquinas afiladas', count: 80, keepPct: 0.7,
    // Sierras diagonales en las esquinas del pasillo y una recta en medio.
    map: [
      '###########',
      '#00C0T0C00#',
      '#000000000#',
    ...
    tips: [
      { z: 8, text: 'Sierras en las esquinas: ve por el centro' },
      { z: 3.5, text: 'Aprieta al salir' },
    ],
  },
  {
  ...
  },
  {
    ...
    tips: [
      { z: 13, text: 'La vía sube a lo alto' },
