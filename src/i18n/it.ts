...
export const it: Dict = {
  ...
  creator: {
    ...
    tiles: {
      ...
      coin: 'Moneta',
      spike: 'Spuntoni',
      wedgeNW: 'Angolo a punta (fondo sx)',
      wedgeNE: 'Angolo a punta (fondo dx)',
      wedgeSE: 'Angolo a punta (fronte dx)',
      wedgeSW: 'Angolo a punta (fronte sx)',
      gem: 'Gemma segreta',
      oil: 'Olio',
      plant: 'Edera (brucia)',
  ...
  levels: {
    ...
    'c1-filo-de-cuchilla': {
      name: 'Punta di pietra',
      tips: ['La punta di pietra divide la melma in due', 'Le due metà si muovono insieme', 'Si riuniscono al contatto, o tieni premuto il tasto stringi'],
    },
    'c1-pasillo-de-fuego': {
