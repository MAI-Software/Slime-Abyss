...
export const it: Dict = {
  ...
  menu: {
    subtitle: 'Dungeon di Slime',
    hint: 'Scivola, dividi e riunisci il tuo slime',
  ...
  story: {
    ...
    reward: 'Al 100%: {item}',
    rewardOwned: 'Ricompensa ottenuta',
  },
  chapters: {
  ...
  shop: {
    title: 'Negozio',
    wallet: '{n} monete',
    hint: 'Guadagni monete raccogliendole nei piani. Gli oggetti sono solo decorativi: non cambiano il gioco.',
    buy: 'Compra · {n}',
    owned: 'Tuo',
    equip: 'Indossa',
    equipped: 'Indossato',
    notEnough: 'Monete insufficienti',
    rewardOnly: 'Ricompensa: completa {chapter} al 100%',
  },
  myslime: {
    title: 'Il mio slime',
    head: 'Testa',
    none: 'Nessuno',
    empty: 'Non hai ancora accessori: comprali nel negozio o completa un capitolo al 100%.',
  },
  profile: {
    title: 'Profilo',
    guest: 'Ospite',
  ...
  items: {
    hat_beanie: 'Berretto della Cripta',
    hat_leaf: 'Fogliolina',
    hat_bow: 'Fiocco',
    hat_party: 'Cappello da festa',
    hat_top: 'Cilindro',
    hat_crown: 'Corona',
  },
  levels: {
