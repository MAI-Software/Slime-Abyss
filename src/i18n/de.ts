...
export const de: Dict = {
  ...
  myslime: {
    ...
    mouth: 'Mund',
    cheeks: 'Wangen',
    colorOpt: { blue: 'Blau', green: 'Grün', pink: 'Rosa', purple: 'Lila', black: 'Schwarz', metal: 'Metallisch', gold: 'Gold' },
    eyesOpt: { round: 'Rund', dot: 'Pünktchen', sparkle: 'Glitzernd', cat: 'Katze', star: 'Sternaugen', heart: 'Verliebt' },
    mouthOpt: { cat: 'Kätzchen', smile: 'Lächeln', fang: 'Eckzahn', tongue: 'Zunge', grin: 'Breites Grinsen', pout: 'Kussmund' },
    cheeksOpt: { lines: 'Striche', spots: 'Rouge', hearts: 'Herzen', none: 'Keine', stars: 'Sternchen', freckles: 'Sommersprossen' },
  },
  collection: {
    title: 'Sammlung',
