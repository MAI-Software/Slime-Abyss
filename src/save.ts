...
export function loadSave(): Save {
  const fresh: Save = { v: 3, control: 'joystick', sound: true, vibration: true, lang: null, floors: {}, collectibles: [], look: { ...DEFAULT_LOOK }, achievements: [], stats: { ...EMPTY_STATS }, joyFixed: false, cameraHint: false };
  try {
    ...
    if (s?.v === 3) {
      ...
      return { ...fresh, ...rest, achievements, stats: { ...EMPTY_STATS, ...rest.stats }, look: sanitizeLook(rest.look, achievements) };
    }
