...
export const de: Dict = {
  ...
  achievements: {
    ...
    board: 'Tafel · Reihe {row}, Spalte {col}',
    new: 'Neuer Erfolg!',
  ...
  creator: {
    ...
    tiles: {
      ...
      coin: 'Münze',
      spike: 'Stacheln',
      wedgeNW: 'Keilecke (hinten links)',
      wedgeNE: 'Keilecke (hinten rechts)',
      wedgeSE: 'Keilecke (vorne rechts)',
      wedgeSW: 'Keilecke (vorne links)',
  ...
  levels: {
    ...
    'c1-filo-de-cuchilla': {
      name: 'Steinkeil',
      tips: ['Der Steinkeil teilt den Schleim in zwei', 'Beide Hälften bewegen sich zugleich', 'Bei Berührung fließen sie wieder zusammen, oder halte die Quetsch-Taste'],
    },
    'c1-pasillo-de-fuego': {
      name: 'Feuergang',
    ...
    'c3-hielo-fundido': {
      ...
      tips: ['Öl und Feuer: wieder brennen', 'Brennend schmilzt das Eis: bleib darauf, um in den Raum darunter zu fallen'],
    },
    'c3-pista-ardiente': {
      name: 'Glühende Bahn',
