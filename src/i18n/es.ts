...
export const es = {
  ...
  myslime: {
    ...
    mouth: 'Boca',
    cheeks: 'Mofletes',
    colorOpt: { blue: 'Azul', green: 'Verde', pink: 'Rosa', purple: 'Morado', black: 'Negro', metal: 'Metálico', gold: 'Oro', rosegold: 'Oro rosa', emerald: 'Esmeralda', midnight: 'Medianoche' },
    eyesOpt: { round: 'Redondos', dot: 'Puntitos', sparkle: 'Brillantes', cat: 'Gatunos', star: 'Estrellados', heart: 'Enamorados', sleepy: 'Dormilones', wink: 'Guiño', glasses: 'Gafas' },
    mouthOpt: { cat: 'Gatito', smile: 'Sonrisa', fang: 'Colmillo', tongue: 'Lengua', grin: 'Sonrisota', pout: 'Morritos', smirk: 'Pícara', vampire: 'Vampiro', wobbly: 'Ondulada' },
    cheeksOpt: { lines: 'Rayitas', spots: 'Coloretes', hearts: 'Corazones', none: 'Sin mofletes', stars: 'Estrellitas', freckles: 'Pecas', swirls: 'Espirales', bandage: 'Tirita', sparkles: 'Destellos' },
  },
  collection: {
    title: 'Colección',
