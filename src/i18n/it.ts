...
export const it: Dict = {
  ...
  myslime: {
    ...
    mouth: 'Bocca',
    cheeks: 'Guance',
    colorOpt: { blue: 'Blu', green: 'Verde', pink: 'Rosa', purple: 'Viola', black: 'Nero', metal: 'Metallico', gold: 'Oro' },
    eyesOpt: { round: 'Tondi', dot: 'Puntini', sparkle: 'Brillanti', cat: 'Da gatto', star: 'Stellati', heart: 'Innamorati' },
    mouthOpt: { cat: 'Gattino', smile: 'Sorriso', fang: 'Canino', tongue: 'Lingua', grin: 'Sorrisone', pout: 'Bacino' },
    cheeksOpt: { lines: 'Linee', spots: 'Rossore', hearts: 'Cuori', none: 'Nessuna', stars: 'Stelline', freckles: 'Lentiggini' },
  },
  collection: {
    title: 'Collezione',
