...
export const ROUTES: Record<string, Step[]> = {
  ...
  'c4-canonazo': [
    ...
    { to: [2.5, 3.5], radius: 0.3 }, { to: [10.5, 3.5], radius: 0.3 }, { to: [6.5, 1.5], t: 6 },
  ],
  ...
  'c4-corazon-de-arena': [
    ...
    { to: [7.5, 4.2], radius: 0.3 }, { dir: [0, 1], t: 1.4 }, { squeeze: true, wait: 2 }, { squeeze: false, to: [2.5, 7.4], radius: 0.4 },
