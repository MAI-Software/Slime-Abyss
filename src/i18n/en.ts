...
export const en: Dict = {
  ...
  myslime: {
    ...
    mouth: 'Mouth',
    cheeks: 'Cheeks',
    colorOpt: { blue: 'Blue', green: 'Green', pink: 'Pink', purple: 'Purple', black: 'Black', metal: 'Metallic', gold: 'Gold' },
    eyesOpt: { round: 'Round', dot: 'Dots', sparkle: 'Sparkly', cat: 'Cat', star: 'Starry', heart: 'Lovestruck' },
    mouthOpt: { cat: 'Kitty', smile: 'Smile', fang: 'Fang', tongue: 'Tongue', grin: 'Big grin', pout: 'Pout' },
    cheeksOpt: { lines: 'Lines', spots: 'Blush', hearts: 'Hearts', none: 'None', stars: 'Little stars', freckles: 'Freckles' },
  },
  collection: {
    title: 'Collection',
