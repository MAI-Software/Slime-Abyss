...
export const fr: Dict = {
  ...
  myslime: {
    ...
    mouth: 'Bouche',
    cheeks: 'Joues',
    colorOpt: { blue: 'Bleu', green: 'Vert', pink: 'Rose', purple: 'Violet', black: 'Noir', metal: 'Métallique', gold: 'Or', rosegold: 'Or rose', emerald: 'Émeraude', midnight: 'Minuit' },
    eyesOpt: { round: 'Ronds', dot: 'Petits points', sparkle: 'Brillants', cat: 'De chat', star: 'Étoilés', heart: 'Amoureux', sleepy: 'Endormis', wink: 'Clin d’œil', glasses: 'Lunettes' },
    mouthOpt: { cat: 'Chaton', smile: 'Sourire', fang: 'Canine', tongue: 'Langue', grin: 'Grand sourire', pout: 'Bisou', smirk: 'Malicieuse', vampire: 'Vampire', wobbly: 'Ondulée' },
    cheeksOpt: { lines: 'Traits', spots: 'Rougeurs', hearts: 'Cœurs', none: 'Aucune', stars: 'Étoiles', freckles: 'Taches de rousseur', swirls: 'Spirales', bandage: 'Pansement', sparkles: 'Éclats' },
  },
  collection: {
    title: 'Collection',
