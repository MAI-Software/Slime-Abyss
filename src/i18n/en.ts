...
export const en: Dict = {
  ...
  myslime: {
    ...
    mouth: 'Mouth',
    cheeks: 'Cheeks',
    colorOpt: { blue: 'Blue', green: 'Green', pink: 'Pink', purple: 'Purple', black: 'Black', metal: 'Metallic', gold: 'Gold', rosegold: 'Rose gold', emerald: 'Emerald', midnight: 'Midnight' },
    eyesOpt: { round: 'Round', dot: 'Dots', sparkle: 'Sparkly', cat: 'Cat', star: 'Starry', heart: 'Lovestruck', sleepy: 'Sleepy', wink: 'Wink', glasses: 'Glasses' },
    mouthOpt: { cat: 'Kitty', smile: 'Smile', fang: 'Fang', tongue: 'Tongue', grin: 'Big grin', pout: 'Pout', smirk: 'Smirk', vampire: 'Vampire', wobbly: 'Wavy' },
    cheeksOpt: { lines: 'Lines', spots: 'Blush', hearts: 'Hearts', none: 'None', stars: 'Little stars', freckles: 'Freckles', swirls: 'Swirls', bandage: 'Bandage', sparkles: 'Sparkles' },
  },
  collection: {
    title: 'Collection',
