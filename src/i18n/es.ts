...
export const es = {
  ...
  story: {
    ...
    reward: 'Al 100 %: {item}',
    rewardOwned: 'Recompensa conseguida',
  },
  chapters: {
  ...
  shop: {
    title: 'Tienda',
    wallet: '{n} monedas',
    hint: 'Las monedas se ganan recogiéndolas en los pisos. Solo son adornos: no cambian nada del juego.',
    buy: 'Comprar · {n}',
    owned: 'Es tuyo',
    equip: 'Poner',
    equipped: 'Puesto',
    notEnough: 'Te faltan monedas',
    rewardOnly: 'Recompensa: completa {chapter} al 100 %',
  },
  myslime: {
    title: 'Mi limo',
    head: 'Cabeza',
    none: 'Nada',
    empty: 'Aún no tienes accesorios: cómpralos en la tienda o completa un capítulo al 100 %.',
  },
  profile: {
    title: 'Perfil',
    guest: 'Invitado',
  ...
  items: {
    hat_beanie: 'Gorrito de la Cripta',
    hat_leaf: 'Hojita',
    hat_bow: 'Lazo',
    hat_party: 'Gorro de fiesta',
    hat_top: 'Chistera',
    hat_crown: 'Corona',
  },
  levels: {
