...
export const de: Dict = {
  ...
  myslime: {
    ...
    mouth: 'Mund',
    cheeks: 'Wangen',
    colorOpt: { blue: 'Blau', green: 'Grün', pink: 'Rosa', purple: 'Lila', black: 'Schwarz', metal: 'Metallisch', gold: 'Gold', rosegold: 'Roségold', emerald: 'Smaragd', midnight: 'Mitternacht' },
    eyesOpt: { round: 'Rund', dot: 'Pünktchen', sparkle: 'Glitzernd', cat: 'Katze', star: 'Sternaugen', heart: 'Verliebt', sleepy: 'Verschlafen', wink: 'Zwinkern', glasses: 'Brille' },
    mouthOpt: { cat: 'Kätzchen', smile: 'Lächeln', fang: 'Eckzahn', tongue: 'Zunge', grin: 'Breites Grinsen', pout: 'Kussmund', smirk: 'Verschmitzt', vampire: 'Vampir', wobbly: 'Wellig' },
    cheeksOpt: { lines: 'Striche', spots: 'Rouge', hearts: 'Herzen', none: 'Keine', stars: 'Sternchen', freckles: 'Sommersprossen', swirls: 'Spiralen', bandage: 'Pflaster', sparkles: 'Funkeln' },
  },
  collection: {
    title: 'Sammlung',
