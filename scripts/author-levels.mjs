...
const CHAPTER5 = [
  {
    ...
    tips: [
      { z: 13, text: 'Los balancines se inclinan hacia donde pesas' },
      { z: 9.5, text: 'Cruza sin pararte: si te quedas, la tabla te tira' },
    ],
  },
  {
    ...
    tips: [
      { z: 15, text: 'La sierra te parte justo entre dos tablas' },
      { z: 9.5, text: 'Aprieta para juntarte antes de la siguiente tabla' },
    ],
  },
  {
    ...
    tips: [
      { z: 14, text: 'El viento empuja mientras la tabla se inclina' },
      { z: 9, text: 'Cruza por el lado del que sopla' },
    ],
  },
  {
    file: 'chapter5/04-c5-espiral-mareante.json',
    id: 'c5-espiral-mareante', name: 'Espiral mareante', count: 80, keepPct: 0.6,
    ...
    tips: [
      { z: 16, text: 'La vía en espiral marea: espera a que se te pase' },
      { z: 12, text: 'Mareado cuesta ir recto: cruza la tabla con calma' },
    ],
  },
  {
    ...
    tips: [
      { z: 18, text: 'El cañón te lanza a la diana de arriba' },
      { z: 8.5, text: 'Arriba, las tablas llevan al tesoro' },
    ],
  },
  {
    ...
    tips: [
      { z: 8, text: 'Tres plantas: se baja por el pozo' },
      { z: 12, text: 'El ascensor baja hasta el tesoro' },
    ],
  },
  {
    file: 'chapter5/07-c5-aceite-en-la-balanza.json',
    id: 'c5-aceite-en-la-balanza', name: 'Aceite en la balanza', count: 80, keepPct: 0.6,
    map: [
      '#############',
      '#000000000T0#',
      '#0C000000000#',
    ...
    tips: [
      { z: 13, text: 'Coge el aceite y préndete entre los braseros' },
      { z: 7, text: 'Ardiendo, quema la hiedra del final' },
    ],
  },
  {
    file: 'chapter5/08-c5-disco-y-tablas.json',
    id: 'c5-disco-y-tablas', name: 'Disco y tablas', count: 80, keepPct: 0.6,
    map: [
      '#############',
      '#0000T000000#',
      '#000000000C0#',
    ...
    tips: [
      { z: 15, text: 'La sierra parte y el disco marea' },
      { z: 8, text: 'Sal del disco antes de marearte del todo' },
    ],
  },
  {
    ...
    tips: [
      { z: 13, text: 'Cruza el balancín y métete por el pozo' },
      { z: 9.5, text: 'Abajo, la vía sube hasta el tesoro' },
    ],
  },
  {
    file: 'chapter5/10-c5-corazon-del-desierto.json',
    id: 'c5-corazon-del-desierto', name: 'El corazón del desierto', count: 80, keepPct: 0.5,
    need: { A: 18 }, latch: { A: true },
    map: [
      '###############',
      '#00000000000T0#',
      '#0C0000C000000#',
    ...
    tips: [
      { z: 12, text: 'Última prueba del desierto: tres plantas' },
      { z: 10.5, text: 'Tablas largas sobre el vacío y disco que marea' },
      { z: 11, text: 'El interruptor abre la sala de la gema' },
    ],
  },
];
