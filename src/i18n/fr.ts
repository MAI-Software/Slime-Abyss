...
export const fr: Dict = {
  ...
  achievements: {
    ...
    board: 'Tableau · rangée {row}, colonne {col}',
    new: 'Nouveau succès !',
  ...
  creator: {
    ...
    tiles: {
      ...
      coin: 'Pièce',
      spike: 'Pointes',
      wedgeNW: 'Coin en pointe (fond gauche)',
      wedgeNE: 'Coin en pointe (fond droite)',
      wedgeSE: 'Coin en pointe (avant droite)',
      wedgeSW: 'Coin en pointe (avant gauche)',
      gem: 'Gemme secrète',
      oil: 'Huile',
      plant: 'Lierre (brûle)',
  ...
  levels: {
    ...
    'c1-filo-de-cuchilla': {
      ...
      tips: ['La pointe de pierre coupe le slime en deux', 'Les deux moitiés bougent ensemble', 'Elles fusionnent au contact, ou maintiens le bouton de serrage'],
    },
    'c1-pasillo-de-fuego': {
      name: 'Couloir de feu',
    ...
    'c3-hielo-fundido': {
      name: 'Glace fondue',
      tips: ['Huile et feu : on s’enflamme à nouveau', 'En flammes, la glace fond : reste dessus pour tomber dans la salle du dessous'],
    },
    'c3-pista-ardiente': {
      name: 'Piste brûlante',
