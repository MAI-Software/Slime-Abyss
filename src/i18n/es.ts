...
export const es = {
  ...
  achievements: {
    ...
    names: {
      ...
      'coins-100': 'Hucha llena',
      'secrets-1': 'Primer secreto',
      'secrets-6': 'Rastreador',
      'secrets-12': 'Maestro de secretos',
      'rubies-9': 'Corona de rubíes',
      'sapphires-9': 'Mar de zafiros',
      'full-slime-10': 'Sin mancha',
      ...
      'fails-10': 'Nunca me rindo',
      'creator-1': 'Arquitecto',
      'creator-10': 'Gran constructor',
    ...
    descs: {
      ...
      'fails-10': 'Pierde 10 pisos y sigue intentándolo',
      'creator-1': 'Guarda un nivel en el creador',
      'creator-10': 'Llena los 10 huecos del creador',
