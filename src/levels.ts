...
export const LEVELS: LevelDef[] = [
  {
    // Sin trampas ni caídas: todo con muros. Sirve para ajustar el control y el equilibrio del limo.
    ...
    tips: [
      { z: 53, text: 'Nivel de prueba: sin trampas, no se pierde limo' },
      { z: 49, text: 'Zigzag: gira con suavidad' },
      { z: 37.5, text: 'Pasillo estrecho: el limo se estira en fila' },
      { z: 32, text: 'Slalom entre columnas' },
      { z: 23.5, text: 'Escalones: SALTAR para subir' },
      { z: 18.5, text: 'Explanada con montículos' },
      { z: 7.5, text: 'Bajada hacia el tesoro' },
    ],
  },
  {
