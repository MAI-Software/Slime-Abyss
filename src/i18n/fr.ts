...
export const fr: Dict = {
  ...
  myslime: {
    ...
    mouth: 'Bouche',
    cheeks: 'Joues',
    colorOpt: { blue: 'Bleu', green: 'Vert', pink: 'Rose', purple: 'Violet', black: 'Noir', metal: 'Métallique', gold: 'Or' },
    eyesOpt: { round: 'Ronds', dot: 'Petits points', sparkle: 'Brillants', cat: 'De chat', star: 'Étoilés', heart: 'Amoureux' },
    mouthOpt: { cat: 'Chaton', smile: 'Sourire', fang: 'Canine', tongue: 'Langue', grin: 'Grand sourire', pout: 'Bisou' },
    cheeksOpt: { lines: 'Traits', spots: 'Rougeurs', hearts: 'Cœurs', none: 'Aucune', stars: 'Étoiles', freckles: 'Taches de rousseur' },
  },
  collection: {
    title: 'Collection',
