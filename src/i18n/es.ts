...
export const es = {
  ...
  myslime: {
    ...
    mouth: 'Boca',
    cheeks: 'Mofletes',
    colorOpt: { blue: 'Azul', green: 'Verde', pink: 'Rosa', purple: 'Morado', black: 'Negro', metal: 'Metálico', gold: 'Oro' },
    eyesOpt: { round: 'Redondos', dot: 'Puntitos', sparkle: 'Brillantes', cat: 'Gatunos', star: 'Estrellados', heart: 'Enamorados' },
    mouthOpt: { cat: 'Gatito', smile: 'Sonrisa', fang: 'Colmillo', tongue: 'Lengua', grin: 'Sonrisota', pout: 'Morritos' },
    cheeksOpt: { lines: 'Rayitas', spots: 'Coloretes', hearts: 'Corazones', none: 'Sin mofletes', stars: 'Estrellitas', freckles: 'Pecas' },
  },
  collection: {
    title: 'Colección',
